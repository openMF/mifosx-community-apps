...
function listProductMix() {
	...
	executeAjaxRequest('loanproducts/productmix', 'GET', "", successFunction, formErrorFunction);
}
...
function launchProductMixDialog(loanProductId) {
	...
	if (loanProductId) {
		...
		executeAjaxRequest('loanproducts/productmix/template', 'GET', "", launchLoanProductMixDialogOnSuccessFunction, formErrorFunction);
	}
}
